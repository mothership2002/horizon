...
/**
 * Abstract base class for web foyers (HTTP and WebSocket).
 * This class provides common functionality for web foyers.
 *
 * @param <I> the protocol-specific input type
 */
public abstract class AbstractWebFoyer<I> implements Foyer<I> {
