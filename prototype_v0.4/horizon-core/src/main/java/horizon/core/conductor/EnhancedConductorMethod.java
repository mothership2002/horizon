...
/**
 * Enhanced conductor method that supports multiple parameters with annotations.
 * This is the evolution of ConductorMethod for more sophisticated parameter handling.
 */
public class EnhancedConductorMethod {
    ...
    public EnhancedConductorMethod(Object instance, Method method, String intent) {
     ...
     */
    public Object invoke(Map<String, Object> context) throws Exception {
    ...
    private Object resolveParameter(ParameterInfo info, Map<String, Object> context) throws Exception {
        ...
        switch (info.source) {
            ...
            case BODY:
                ...
                if (value == null) {
                    // Fallback to the entire context as body
                    value = context;
                }
                break;
        }
