...
public class HorizonChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    private final HorizonContext<NettyHttpRawInput, NettyHttpRawOutput> context;

    public HorizonChannelInitializer(HorizonContext<NettyHttpRawInput, NettyHttpRawOutput> context) {
